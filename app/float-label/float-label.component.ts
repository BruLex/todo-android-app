...
@Component({
    ...
    template: `
        <GridLayout rows="30, auto" marginBottom="5">
            <Label
                    [width]="width" #label row="1" [text]="placeholder" opacity="0.4" fontSize="14"
                    class="input"></Label>
            <TextField
                    *ngIf="type === 'field'" #textField
                    [width]="width"
                    [secure]="secure" row="1"
                    [ngModel]="_value"
...
export class FloatLabel implements OnDestroy {
