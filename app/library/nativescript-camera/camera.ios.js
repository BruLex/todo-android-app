...
var UIImagePickerControllerDelegateImpl = (function(_super) {
    ...
    UIImagePickerControllerDelegateImpl.prototype.initWithCallbackAndOptions = function(
        callback,
        errorCallback,
        options
    ) {
    ...
    UIImagePickerControllerDelegateImpl.prototype.imagePickerControllerDidFinishPickingMediaWithInfo = function(
        picker,
        info
    ) {
        var _this = this;
                        ...
                        PHPhotoLibrary.sharedPhotoLibrary().performChangesCompletionHandler(
                            ...
                            function(success, err) {
                                if (success) {
                                    ...
                                    var sortDescriptors = NSArray.arrayWithObject(
                                    ...
                                    trace.write(
                                        'An error ocurred while saving image to gallery: ' + err,
    ...
    UIImagePickerControllerDelegateImpl.prototype.setImageAssetAndCallCallback = function(imageAsset) {
        if (this._keepAspectRatio) {
            ...
            var pictureHeight = imageAsset.nativeImage
                ? imageAsset.nativeImage.size.height
                : imageAsset.ios.pixelHeight;
